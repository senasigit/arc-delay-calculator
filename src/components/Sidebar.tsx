    ...
    <div className="w-80 h-full bg-dark-panel border-r border-dark-border flex flex-col overflow-y-auto">
      <div className="p-6 pb-2">
        ...
        <div className="mb-4 bg-[#0f1115] p-4 rounded border border-dark-border space-y-2 shadow-inner">
          ...
          <div className="flex justify-between items-center">
             <span className="text-xs text-gray-400">Jarak Pusat (S-center)</span>
      ...
      <div className="flex-1 px-6 space-y-4 pb-6 overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col">
            <label htmlFor="orientation" className="text-xs font-medium text-gray-300 mb-1">Orientasi Box</label>
            <select 
              id="orientation"
              name="orientation"
          ...
          <div className="flex flex-col">
            <label htmlFor="stack" className="text-xs font-medium text-gray-300 mb-1">Stack (Tumpukan)</label>
            <input 
              id="stack"
              type="number" 
              name="stack"
        ...
        <div className="flex flex-col border-t border-dark-border pt-4 mt-2">
          <div className="flex items-center mb-3">
            ...
            />
            <label htmlFor="cardioid" className="ml-2 text-sm font-medium text-gray-300">Gunakan Gradient Cardioid</label>
          </div>
        ...
        <div className="flex flex-col border-t border-dark-border pt-4 mt-2 space-y-3">
          ...
          <div className="flex flex-col">
            <label htmlFor="resolution" className="text-xs font-medium text-gray-300 mb-1">Kualitas Peta (Render)</label>
            <select 
              id="resolution"
              name="resolution"
